...
public class Route implements Serializable, Comparable {
     ...
     */
    private dto.locations.locationFrom.Location from;
     ...
     *
     * @see Route#Route(long, String, Coordinates, LocalDate, dto.locations.locationFrom.Location, Location, int)
     ...
     * @see Route#Route(long, String, Coordinates, LocalDate, Location, int)
     */
    public Route(long id, String name, Coordinates coordinates, LocalDate localDate, dto.locations.locationFrom.Location from, Location to, int distance) {
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = localDate;
     ...
     * @return x
     */
    public dto.locations.locationFrom.Location getFrom() {
        return from;
    }

    public void setFrom(dto.locations.locationFrom.Location from) {
        this.from = from;
    }
